...
# Reconcile direct package installs and interrupted maitri setup as well.
if command -v maitri-install-hermes-cli >/dev/null 2>&1; then
  maitri-install-hermes-cli >/dev/null 2>&1 || true
fi
